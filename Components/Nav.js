    ...
    return (
        <div className="mb-30 md:mb-40">
            <nav className="container fixed inset-x-0 top-0 bg-white z-10 p-2">
                <h1 className="text-l md:text-2xl lg:text-3xl md:m-5 font-bold font-serif text-green-700">PHONE-<span className='text-purple-700 inline'>MALL <IoIosPhonePortrait size={30} className='inline' /></span>
